...
ShopGenre.find_or_create_by(id:1, name: "和風")
ShopGenre.find_or_create_by(id:2, name: "洋風")
ShopGenre.find_or_create_by(id:3, name: "中華")
ShopGenre.find_or_create_by(id:4, name: "食えればなんでもOK")
ShopGenre.find_or_create_by(id:5, name: "イタリアン")
ShopGenre.find_or_create_by(id:6, name: "おうちでParty！！")
ShopGenre.find_or_create_by(id:7, name: "葬式")
ShopGenre.find_or_create_by(id:8, name: "結婚式")
ShopGenre.find_or_create_by(id:9, name: "宴会")
ShopGenre.find_or_create_by(id:10, name: "デザート")
ShopGenre.find_or_create_by(id:11, name: "ジャンク")
